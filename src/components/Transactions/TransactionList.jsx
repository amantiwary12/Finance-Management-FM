...
import { FaTrash, FaImage, FaTimes, FaProjectDiagram, FaUser } from "react-icons/fa";
...
const TransactionList = ({
  ...
  const showUserColumn = userRole === 'Admin' || userRole === 'FinanceManager';
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {transactions.map((transaction) => {
                const projectName = getProjectName(transaction.project);
