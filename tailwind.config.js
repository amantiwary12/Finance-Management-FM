  ...
  theme: {
    extend: {
      colors: {
        ...
        // Money-green primary (replaces the old blue across the whole app)
        blue: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
        ...
        // Teal secondary (replaces indigo/purple-blue gradients)
        indigo: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Green-tinted neutral scale — keeps light surfaces readable but on-theme
        gray: {
          50: '#f3f6f4',
          100: '#e6ede8',
          200: '#d4dfd8',
